            ...
            <form action="{{ route('admin.homepage-banner-secion-one') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label class="custom-switch mt-2">
                        <input type="checkbox"
                            {{ $homepage_secion_banner_one->banner_one->status == 1 ? 'checked' : '' }} name="status"
                            class="custom-switch-input">
                        <span class="custom-switch-indicator"></span>
                    </label>
                </div>
                <div class="form-group">
                    <img src="{{ asset($homepage_secion_banner_one->banner_one->banner_image) }}" alt=""
                        width="150px">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner_url"
                        value="{{ $homepage_secion_banner_one->banner_one->banner_url }}">
                </div>
