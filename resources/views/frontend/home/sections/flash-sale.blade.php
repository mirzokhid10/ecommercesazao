    ...
    <div class=" container">
        ...
        <div class="row flash_sell_slider">
            @foreach ($flashSaleItems as $item)
                @php
                    $product = \App\Models\Product::with('review')->find($item->product_id);
                @endphp
                    ...
                    <div class="wsus__product_item">
                        ...
                        <a class="wsus__pro_link" href="{{ route('product-detail', $product->slug) }}">
                            ...
                            <img src="
                                ...
                                @else {{ asset($product->thumb_image) }} @endif "alt="product"
                                class="img-fluid w-100 img_2" />
                        </a>
                        <ul class="wsus__single_pro_icon">
                            <li><a href="#" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal-{{ $product->id }}" class="show_product_modal"
                                    data-id=""><i class="far fa-eye"></i></a>
                            </li>
